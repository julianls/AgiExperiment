...
namespace AgiExperiment.AI.Domain.Data
{
    ...
    public class ConversationCreatorAndDeleter
    {
        ...
        public ConversationCreatorAndDeleter(IDbContextFactory<AiExperimentDBContext> dbContextFactory, 
    ...
    public class SampleDataSeeder
    {
        ...
        public SampleDataSeeder(IDbContextFactory<AiExperimentDBContext> dbContextFactory, ScriptRepository scriptRepository, QuickProfileRepository quickProfileRepository)
        {
            _dbContextFactory = dbContextFactory;
            _quickProfileRepository = quickProfileRepository;
            _scriptRepository = scriptRepository;
