...
{
    private readonly IDbContextFactory<AiExperimentDBContext> _contextFactory;
    ...
    public ChatWrapper(KernelService kernelService, IInterceptorHandler interceptorHandler,
        ...
        IDbContextFactory<AiExperimentDBContext> contextFactory, IOptions<PipelineOptions> pipelineOptions)
    {
