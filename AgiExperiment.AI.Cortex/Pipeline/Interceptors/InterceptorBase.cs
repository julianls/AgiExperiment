...
{
    private IDbContextFactory<AiExperimentDBContext> _context;
    ...
    public InterceptorBase(IServiceProvider serviceProvider)
    {
        ...
        _context = serviceProvider.GetRequiredService<IDbContextFactory<AiExperimentDBContext>>();
    }

    protected InterceptorBase(IDbContextFactory<AiExperimentDBContext> context, ConversationsRepository conversationsRepository)
    {
